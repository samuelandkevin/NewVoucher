...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        labelTitle.textColor = [UIColor colorWithRed:0 green:106/255.0 blue:251/255.0 alpha:1.0];
...
- (void)initSubViews{
    ...
    self.backgroundView.backgroundColor = [[UIColor colorWithRed:195/255.0 green:195/255.0 blue:197/255.0 alpha:1.0] colorWithAlphaComponent:0.5];
